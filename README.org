...
*** Emacs 26.1+ with dynamic modules support. Need to add ~--with-modules~ option when compiling it.
...
***** When installing emacs-mac, you need to add ~--with-modules~ option.
#+BEGIN_SRC shell
